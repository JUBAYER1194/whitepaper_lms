                ...
                <v-card-text>
                    <v-container>
                        ...
                        <div class="form-group">
                            <h4>Add File:</h4>
                            <input  accept=".doc,.docx,.pptx,.pdf,.jpeg,.png,.wav,.mp3,.avi,.flv,.mkv,.mp4,.mpg" type="file"  @change="filechanged"   class="form-control form-control-lg" placeholder="Large form control">
                        </div>
