...
<template>
    <v-container class="grey lighten-4" style="padding-bottom:25%;margin-top: 0.5%;height: 100%">
        <v-btn rounded style="background-color: #3b5998;color: white">Create Class</v-btn>
        <br>
        <br>
            <v-simple-table
                fixed-header
                ...
                <template v-slot:default>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <v-btn  width="60"   class="primary mx-lg-6">Edit</v-btn>

                            <v-btn width="60" class="error">Delete</v-btn>
                        </td>
                    </tr>
                    </tbody>
                </template>
